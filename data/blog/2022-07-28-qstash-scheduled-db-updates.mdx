---
slug: qstash-scheduled-db-updates
title: "Scheduled database updates in Next.js serverless functions"
author: andreas
...
[application](https://qstash-examples-scheduled-db-updates.vercel.app) to
...
The first step is to get updated data from the API (blockchain.info in this
...
The file can be found [here](https://github.com/upstash/qstash-examples/blob/main/scheduled-db-updates/pages/api/cron.ts).
...
[quickstart](https://docs.upstash.com/qstash/quickstarts/vercel-nextjs#4-deploy-to-vercel).
...
![](/blog/qstash/scheduled-db-updates/vercel_env.png)
...
![](/blog/qstash/scheduled-db-updates/schedule.png)

## Wrapping up

That's it, your serverless function will now be called regularly and will insert
...
[here]([index.tsx](https://github.com/upstash/qstash-examples/blob/main/scheduled-db-updates/pages/index.tsx).

![](/blog/qstash/scheduled-db-updates/app.png)

If you have any questions, please reach out to us on
[Discord](https://discord.com/invite/w9SenAtbme) and
...
- Code:
  [Repository](https://github.com/upstash/qstash-examples/tree/main/scheduled-db-updates)
- App:
  [qstash-examples-scheduled-db-updates.vercel.app](https://qstash-examples-scheduled-db-updates.vercel.app)
