...
AgentKit itself is MIT-licensed and free. You pay for the Redis database behind it, and [Upstash Redis pricing](https://upstash.com/pricing/redis) starts at a free tier with 250 MB of storage and 500K commands a month. Pay-as-you-go is $0.20 per 100K commands.
