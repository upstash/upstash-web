...
title: "Storing Time Series Data in Redis: From Naive to Native"
authors:
  - arda
...
For **Upstash Redis**, **Streams are clearly the best choice** for time series data today. They outshine Lists and Sorted Sets with memory efficiency that scales to millions of data points, and built-in range queries without complex workarounds.
...
While Redis TimeSeries offers native aggregations and specialized optimizations, it's not yet available in Upstash Redis—though it's on our roadmap. Until then, Streams provide the perfect balance of performance and functionality for your time series needs.

[Follow us on X](https://x.com/upstash) for updates on TimeSeries availability and other exciting features!

## Further Reading

- [Redis TimeSeries Documentation](https://redis.io/docs/latest/develop/data-types/timeseries/) - Official Redis TimeSeries guide
