...
You can reach the demo of the app [here](https://next-message.fly.dev/). Current version of the application is deployed to [Fly](fly.io).
...
```typescript /pages/user/[username].tsx
...
```typescript /server/message_server.ts
...
You can find the Github repository of the project [here]([github.com](https://github.com/upstash/examples/tree/main/examples/next-chatapp-with-kafka))

If you want to keep improving the project, you could implement multiple message servers, and a load balancer to apply the best system design practices.

If you have any questions, you can react me at fahreddin@upstash.com