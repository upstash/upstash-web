...
- A [Next.js](https://nextjs.org) project where we'll create the story generator functionality
...
First up we'll want to create a Next.js project. This can be done by running the following to create a new Next.js project with TypeScript. You can find out the steps to setup Next.js [here](https://nextjs.org).
