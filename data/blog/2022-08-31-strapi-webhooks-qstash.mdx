...
looking at Strapi's integrated webhooks, to send a message under certain conditions.
...
One more thing...
Create your first administrator ð» by going to the administration panel at:
...
From now on, you no longer have to worry about losing webhooks in case your API is
temporarily down for updates, not reachable over the network, or some unforeseen
error occurred. By default, we are retrying failed messages a couple of times with
