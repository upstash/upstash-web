...
- [Upstash](https://console.upstash.com/auth/sign-in) to store the list of words we want to filter
...
To create a new Vercel project, [open the New Project page](https://vercel.com/new) in a browser. After connecting Vercel with your GitHub account, you can choose a repository to import.
