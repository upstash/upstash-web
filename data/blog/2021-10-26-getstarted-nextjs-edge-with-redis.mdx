...
Check [the repo](https://github.com/upstash/examples/tree/master/examples/nextjs-edge).
...
- Next.js Edge examples: [https://github.com/upstash/redis-js/tree/main/examples/nextjs-app-router](https://github.com/upstash/redis-js/tree/main/examples/nextjs-app-router)
