...
<Note>
See [Multi-Zone High Availability](https://upstash.com/docs/redis/overall/enterprise#multi-zone-high-availability) for a simple explanation of how multi-zone high availability affects your bill.
</Note>
