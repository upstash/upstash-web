...
We use two special lists in Redis to make our autocomplete work:

### 1. Movie Titles List: `movies` 

Think of this like a dictionary that helps us find movies quickly. When someone types "int", we can instantly find all movies that start with those letters.
...
### 2. Popular Movies List: `movie-popularity`

This is our "trending movies" list. Every time someone clicks on a movie in the search results, that movie gets more popular. The most clicked movies show up first in future searches.
