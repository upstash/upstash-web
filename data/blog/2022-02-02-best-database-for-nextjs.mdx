...
- Data (REST) API has been recently [announced](https://www.mongodb.com/docs/atlas/app-services/data-api/). This allows you to access your database using HTTP.
- MongoDB Atlas has a Serverless plan with [some limitations.](https://www.mongodb.com/docs/atlas/reference/flex-limitations/) The pricing of this plan is per operations so it scales to zero as expected from a serverless product.
