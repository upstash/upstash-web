...
Rate limiting with a single database is straightforward. You create a database on [Upstash](https://console.upstash.com/) and start using it:
...
your users will enjoy the latency of whichever database is closest to them.
