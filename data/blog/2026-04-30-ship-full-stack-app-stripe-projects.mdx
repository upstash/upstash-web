...
If you don't have the CLI yet, the [Stripe Projects docs](https://docs.stripe.com/projects) cover installation. After that, `stripe projects add upstash/redis` in any directory is enough to see how the credentials end up in `.env`. Everything else composes on top of that one command.
