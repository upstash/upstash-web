---
slug: rate-limiting-with-python
title: "How to Rate Limit Your Python Applications with Upstash Redis?"
authors:
  - eray
...
Before starting to code, we must create a database on [Upstash](https://console.upstash.com/auth/sign-in) and install the rate limiting library. To install the library, open your library and enter this command:
