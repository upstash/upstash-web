...
<Summary>
  ...
  - We use this setup to test Docs7 against public Mintlify repositories every night and to turn the differences into issues.
</Summary>
...
The tests that live longest do not describe how a page should look. They describe what a reference does. The reference can be the previous release, a staging deployment, or another implementation of the same format. Run both on the same input, on two ports, and ask both the same questions.
