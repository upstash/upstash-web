...
`@upstash/ratelimit` implements three different standardized algorithms so far, and you can read more about them in the projects [README](https://github.com/upstash/ratelimit#ratelimiting-algorithms).
