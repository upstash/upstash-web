...
- **[Agent Analytics](https://github.com/upstash/agent-analytics)** — records when AI crawlers like ChatGPT, Claude, and Perplexity hit your site ([how it works](https://upstash.com/blog/track-ai-crawlers-with-upstash-agent-analytics)).
...
- **Pay-as-you-go** — per command plus storage, and it scales to roughly $0 when idle. Good for spiky, low, or early-stage workloads. The free tier covers 250 MB and 500K commands a month.
