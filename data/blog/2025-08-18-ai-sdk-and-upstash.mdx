...
Here's an [example use case](https://x.com/cahidarda/status/1954946013141033128) where a chatbot learns and remembers:
...
Here's how to build truly [durable LLM streams](https://upstash.com/blog/resumable-llm-streams) using Upstash Workflow & Redis and and the AI SDK:

```ts title="app/api/llm-stream/route.ts"
import {
  MessageType,
  StreamStatus,
  type ChunkMessage,
...
You feel like you're building your API as usual, trusting Workflow to handle the rest. Check out the [Agents API](https://upstash.com/docs/workflow/agents/overview) to see how Upstash Workflow and AI agents can work in harmony.
