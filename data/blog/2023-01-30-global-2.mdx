...
This is an important release for us, so we need your feedback and contributions. Check [the global database documentation](/docs/redis/features/globaldatabase). Reach out to us on [Discord](https://upstash.com/discord) and [Twitter](https://twitter.com/upstash) for your comments and suggestions..
