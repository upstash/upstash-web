...
Since our initial release last year, Upstash has been compatible with the Redis® API up to version 5. Our Redis offering was lacking
...
- [AUTH](https://redis.io/commands/auth/): The Auth command now supports the ACL `username` parameter.
