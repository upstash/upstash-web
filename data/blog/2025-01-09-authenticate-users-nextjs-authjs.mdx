...
Further, create a file named `auth.ts` in the `lib` directory with the following code:
...
Finally, create a file named `providers.ts` in the `lib` directory with the following code:
