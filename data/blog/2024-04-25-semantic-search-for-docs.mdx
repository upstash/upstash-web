...
Navigate to [Upstash Console](https://console.upstash.com/auth/sign-in) and create an account if you don't have already. Then, login to your account and go to Vector using the bar at the top of the page. After that click `Create Index`.
