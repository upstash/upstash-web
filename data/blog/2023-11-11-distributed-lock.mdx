...
You can see a demo of this in action [here](https://todo-host-upstash-lock-demo.com).
...
Using Upstash Redis, we can use the `SETNX` command to set a key if it doesn’t already exist, making
