...
We will keep our data in Upstash Redis. So, [create an Upstash database](https://console.upstash.com/). We will use an HTTP-based Upstash client. Let's install:
...
> Copy/paste `UPSTASH_REDIS_REST_URL` and `UPSTASH_REDIS_REST_TOKEN` from [Upstash console](https://console.upstash.com/).
...
Now, everything is ready! I am planning to implement the same TODO application with Next.js and SvelteKit. Then, I will compare my experience with these frameworks.

Stay tuned and follow us on [Twitter](https://twitter.com/upstash) and [Discord](https://discord.gg/w9SenAtbme).
