...
categories: [AWS Chalice, Slackbot]
---
...
- `/event get-all` :
  ...
  ![get-all_display](/blog/event_reminder_slackbot/get-all_display.png)

- `/event get-all birthday` :

  Shows all birthdays that are set.

  ![get-all_birthday](/blog/event_reminder_slackbot/get-all_birthday.png)

- `/event get-all anniversary` :

  Shows all anniversaries that are set.

  ![get-all_anniversary](/blog/event_reminder_slackbot/get-all_anniversary.png)

- `/event get-all custom` :

  Shows all custom events that are set.

  ![get-all_custom](/blog/event_reminder_slackbot/get-all_custom.png)
...
- `/event get birthday <user>` :
  ...
  ![get_birthday_display](/blog/event_reminder_slackbot/get_birthday_display.png)

- `/event get anniversary <user>` :

  Shows the anniversary details for the user, when they started working there.

  ![get_anniversary_display](/blog/event_reminder_slackbot/get_anniversary_display.png)

- `/event get custom <event_name>(can be found with get-all)` :

  Shows the custom event details using the message provided.

  ![get_custom_display](/blog/event_reminder_slackbot/get_custom_display.png)
...
- ### Remind General Channel
  ...
  ![general_message](/blog/event_reminder_slackbot/general_message.png)

- ### Private Message From Bot
  When the time approaches, slackbot will send private reminder messages.
  ![private_message](/blog/event_reminder_slackbot/private_message.png)
...
![chalice_create](/blog/event_reminder_slackbot/chalice_create.png)
...
Run: `chalice local`
![local-deployment](/blog/event_reminder_slackbot/chalice_local.png)
...
> ![ngrok](/blog/event_reminder_slackbot/ngrok8000.png)
...
- `chalice deploy` for final deployment on AWS Lambda and API Gateway.
  ![chalice_deploy](/blog/event_reminder_slackbot/chalice_deploy.png)
