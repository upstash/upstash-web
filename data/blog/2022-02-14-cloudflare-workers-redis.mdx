...
If you are using Cloudflare Workers, [Upstash Global Redis](/docs/redis/features/globaldatabase) and [Workers KV](https://developers.cloudflare.com/kv/) are probably your best options to keep your data. In this post, I will briefly compare them as a data store for your Cloudflare Workers functions.
