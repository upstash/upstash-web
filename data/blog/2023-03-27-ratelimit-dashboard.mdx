...
title: "Announcing the Ratelimit Dashboard"
author: andreas
...
**Ratelimit Dashboard**! As the library gains more popularity, we have been
...
limits apply to different users in an application. The Ratelimit Dashboard
...
access the Ratelimit Dashboard by visiting
...
built on top of [Upstash Redis](https://upstash.com/). It allows you to easily
...
configuring it in the Ratelimit constructor:
...
Once you've enabled analytics, you can access the Ratelimit Dashboard by
...
monitoring. ![Select Database](/blog/ratelimit-dashboard/select-db.png)
