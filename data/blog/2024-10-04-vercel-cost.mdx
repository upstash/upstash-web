...
In summary, you can offload any HTTP request and have it run for much longer than your serverles function timeout allows. You're not billed for any idle waiting time, and your code execution automatically resumes when the API response is ready.
