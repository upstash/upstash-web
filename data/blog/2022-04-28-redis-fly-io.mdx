...
does not have any connection problems in stateless runtime.

In this article, I will create a basic Node.js application that accesses
Upstash Redis and deploy it on the Fly.io platform.
...
- Run the application locally:
  `node server.js`
- Launch and deploy on fly.io:
  `flyctl launch`
- You can redeploy your app with `flyctl deploy`

- See your application's URL with `flyctl status`
- You can also check your application from the fly.io dashboard:

![](/blog/flyio/dashboard.png)

## Closing Words

In this article, we have showcased how to use Upstash Redis on the Fly.io
