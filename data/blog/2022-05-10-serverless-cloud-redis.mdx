...
Select `Next.js` as the template so that a new Next.js project will be generated.
...
Update user.js as below, replacing the Upstash REST URL and Token:
...
In the Serverless Cloud interactive CLI, run `dev`. You should see something like the following on your http://localhost:3000/:
