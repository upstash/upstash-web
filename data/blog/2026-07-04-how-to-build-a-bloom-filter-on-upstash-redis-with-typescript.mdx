...
In this article we build one in TypeScript and I wanna show you the hashing, how to calculate the sizing, we'll build a reusable class, and we'll try out the filters false positive rate.
