...
There are multiple alternative rate limiting solutions at different layers. I will list 3 main ones with a brief pros/cons analysis.
...
module.exports.hello = async (event) => {
  the clientIp = getClientIp(event) || "NA";
