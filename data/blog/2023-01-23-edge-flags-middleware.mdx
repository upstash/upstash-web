...
Edge-Flags allows you to easily manage feature flags for your serverless applications. It's built on top of Upstash Redis with powerful geolocation rules.
...
Then we can create a new flag named `eu-countries` and add all the countries within the EU.
...
3. Create a sophisticated `/blocked` page
...
<Note title="Geolocation in development">
  Geolocation data is not available when developing locally. You need to actually
