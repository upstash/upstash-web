...
In our example app we only want to make content available to our users in the EU, so we'll [create](https://console.upstash/redis?new=true) a new Redis database and then go to the [edge-flags](https://console.upstash.com/edge-flags) page.
