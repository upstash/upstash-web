---
slug: query
title: "Type-safe Queries for Redis"
authors:
  - andreas
...
That doesn't sound like much fun to do manually, does it? So, we solved it for you.
...
Getting started is a straightforward process. This quick start is loosely based on the example above; let's dive right in:
