...
Beyond our own examples, the community has built impressive Redis-powered tools for AI applications. The [ai-sdk-tools suite from Midday](https://github.com/midday-ai/ai-sdk-tools) includes a [tool result caching package](https://www.npmjs.com/package/@ai-sdk-tools/cache) that uses Redis to cache AI SDK tool results, as [shown in this example](https://x.com/pontusab/status/1975174869856969079), dramatically improving performance and reducing costs:

![ai-sdk-tools-upstash-cache](/blog/mcp-with-redis/ai-sdk-tools-upstash-cache.png)
