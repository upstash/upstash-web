...
## MongoDB Atlas Setup
You can create a serverless MongoDB database in [Atlas console](https://cloud.mongodb.com/). Check [this guide](https://docs.upstash.com/kafka/connect#create-a-mongodb-database) for step-by-step instructions (do not create a connector yet). You will need the url and credentials in the next step.
...
![Kafka Usecases - web analytics w_ vercel_mongo_2](/blog/vercel-edge-mongodb/con2.png)
