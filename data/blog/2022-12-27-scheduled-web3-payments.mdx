...
Web3 is a confusing place for a Web2 developer. The rules here are different, so the solutions must be as well.
...
To enable a decentralized financial system, we need to build core primitives that make it easy to do things in traditional finance in Web3. For a better future!
