...
You can reach the demo of the app [here](https://next-chatapp-with-kafka.fly.dev/). Current version of the application is deployed to [Fly](https://fly.io/).
...
Navigate to the [Upstash Console](https://console.upstash.com) and login, then on the **Redis** tab, click **Create Database** button.
