...
![web3-before-connection](/img/blog/web3_preferences/web3-before-connection.png)

#### User connected via Metamask for the first time. Default Template.
![web3-initial-preferences](/img/blog/web3_preferences/web3-initial-preferences.png)
...
![web3-changed-preferences](/img/blog/web3_preferences/web3-changed-preferences.png)
