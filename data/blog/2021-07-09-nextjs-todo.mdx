...
- Database: [Upstash Redis](https://upstash.com) with [REST API](/docs/redis/features/restapi)
...
And finally update the styles/Home.module.css file as [here](https://github.com/upstash/examples/blob/main/examples/nextjs-todo/styles/Home.module.css).
