...
The code behind the auto-pipelining logic is available [here](https://github.com/upstash/redis-js/blob/8cf620974c5b1b1579998ea92f8e311ae1a1267a/packages/redis/pkg/auto-pipeline.ts#L1).
