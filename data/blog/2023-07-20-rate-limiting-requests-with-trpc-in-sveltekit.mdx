...
We use `trpcLoad(events, (t) => t.public.cat.getMany())` to load all the cats.
...
Appreciate your time reading this blog post. For more insightful discussion or to ask questions, you should come hang out in the [Upstash Discord](https://discord.gg/hEHsgSHtT7) community.
