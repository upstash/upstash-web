...
- Creates an authorization URL like earlier as [a hack](https://github.com/xdevplatform/twitter-api-typescript-sdk/issues/25#issuecomment-1272391910) to update the internal state created by SDK.
