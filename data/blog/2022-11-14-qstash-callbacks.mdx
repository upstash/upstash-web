...
Dom from our friends at [Vercel](https://vercel.com) has already built an example project that uses QStash callbacks to call the DALL-E API and store the generated images in redis to show them in the UI.
Check it out here:
