...
Check out the [documentation](/docs/workflow/features/invoke) for more details.
...
Check out the [documentation](https://upstash.com/docs/workflow/api-reference/logs/list-workflow-run-logs) for more details.
