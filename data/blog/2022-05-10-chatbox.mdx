...
Instant, interactive communication is crucial for a satisfactory user experience. This is why many companies provide a live chatbox widget on their websites.

## What it is

This is a chatbox widget, alongside an admin chat panel for websites, connecting users with developers/admins. This way, interactive communication between peers can be established.
...
### 1. Create a Database and Environment Variables
...
Options can be passed as React props
...
we highly appreciate your feedback and ideas. If you want to give any feedback or thoughts on our services, you can do so via [twitter](https://twitter.com/upstash) or [discord](https://upstash.com/discord).
