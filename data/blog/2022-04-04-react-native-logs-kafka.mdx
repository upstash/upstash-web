...
To use Upstash Kafka, first thing to do is [login](https://console.upstash.com/auth/sign-in) and connect to [console](https://console.upstash.com/kafka) . As the second step, we need a Kafka cluster to use.
