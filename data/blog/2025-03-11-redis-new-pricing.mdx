...
Based on your feedback, we've reworked our fixed pricing options. Unlike our previous Pro Plans, which started at $280/month per DB, our new fixed plans start at $10/month per DB. With these new, cheaper fixed plans, we aim to cover use cases of Upstash Redis for non-serverless environments.
