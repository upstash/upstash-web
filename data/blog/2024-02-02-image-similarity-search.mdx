...
- A [Upstash](https://upstash.com/) account. If you don't have one, you can [sign up for free](https://console.upstash.com/auth/sign-in).
- [Python](https://www.python.org/downloads/) 3.6 or higher
- [PyTorch](https://pytorch.org/get-started/locally/) installed
- [Pillow](https://pillow.readthedocs.io/en/stable/) installed
- [Upstash Python Module](https://pypi.org/project/upstash-vector) installed
