...
The Strapi [REST Cache](https://community.strapi.io/marketplace/strapi-cache) is a collection of Strapi plugins. They help you add LRU caching to your Strapi app, lowering the actual database requests.
...
For this tutorial, you need [an Upstash account](https://console.upstash.com/auth/sign-in) and [a Node.js installation](https://nodejs.org/en/). You also need [Yarn](https://yarnpkg.com/getting-started/install), which is the preferred package manager of Strapi.
...
The first Upstash Redis database is even free, so [check it out](https://console.upstash.com/auth/sign-in); no credit card required!
