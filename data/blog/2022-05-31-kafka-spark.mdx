...
First, let’s create a keyspace in our database. We are going to use CQL “Cassandra Query Language” for doing operations on the database. Here is the [documentation](https://cassandra.apache.org/doc/latest/cassandra/developing/cql/ddl.html) of it.
...
For more detailed and complex configuration, please check [documentation](https://cassandra.apache.org/doc/latest/cassandra/developing/cql/).
