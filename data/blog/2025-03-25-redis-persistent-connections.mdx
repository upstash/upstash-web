...
Not only that 1 line change made all the difference in memory & latency it can also potentially save you money if you are running on an
Upstash Redis Pay as you go Plan since the AUTH & INFO commands are not being executed on every request.
