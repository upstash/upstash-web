...
We expect grounding to be the big use case. Search engines like Exa already ground agents on the open web. Context7 Search does the same for coding agents, with results from official docs only. Think of it as **Exa for code**.
