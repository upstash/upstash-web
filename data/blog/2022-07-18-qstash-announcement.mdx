...
title: "Announcing qStash: Messaging for the Serverless"
author: enes
tags: [qstash, redis, queue]
---

We are proud and excited to announce [qStash](https://console.upstash.com/qstash). Formally, qStash is a message queue and task scheduler designed for serverless runtimes. Informally, qStash is a glue for your serverless functions.
