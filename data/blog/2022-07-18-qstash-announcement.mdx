...
<Note title="Update - September 2022">
  ...
  Pricing](/pricing/qstash) page for the latest pricing information.
</Note>
...
QStash aims to provide the best messaging service for the serverless world. This is our first release, so we strongly need your feedback and contributions. Check [the QStash documentation](/docs/qstash). Reach out to us on [Discord](https://upstash.com/discord) and [Twitter](https://twitter.com/upstash) for your comments and suggestions..
