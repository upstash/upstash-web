...
If you don't have a database or cluster yet, the dropdown allows you to create
new one on the fly.

The integration will set all the required environment variables in your Vercel
