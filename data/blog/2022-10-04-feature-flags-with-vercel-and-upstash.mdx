...
You need [a GitHub account](https://github.com/login), [a Vercel account](https://vercel.com/signup), and [an Upstash account](https://console.upstash.com/auth/sign-in).
