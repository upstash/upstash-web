...
description: "Fable 5 is Anthropic's most capable model and priced like it. Here's how to spend it deliberately: model tiering with subagents, effort tuning, prompt caching, and cutting input tokens with Context7. The same techniques cut token costs on any Claude model."
---
...
Per [Anthropic's pricing](https://platform.claude.com/docs/en/about-claude/models/overview), Fable costs $10 per million input tokens and $50 per million output, double Opus 4.8's $5 / $25 and five times Sonnet 5's introductory $2 / $10 ([through August 31, 2026](https://platform.claude.com/docs/en/about-claude/models/overview)). Those rates are about to matter more: inside the Claude subscription Fable was capped at 50% of weekly usage limits, and on July 7, 2026 it leaves the subscription entirely. After that, using it means paying the API price.

<Note>
  **Update (July 13, 2026):** Anthropic has [extended Fable 5 access in subscription plans to July 19](https://x.com/claudeai/status/2076351399999557669). The techniques below are not Fable-specific, though: they apply on any model and any plan whenever you want to cut token costs.
</Note>
...
## Model tiering with subagents: Fable to think, cheaper models to do
