...
author: enes
image: /blog/fastly/cover.png
tags: [serverless, fastly, edge, redis]
---


* This example uses an older version of Fastly CLI. Check [this article](https://docs.upstash.com/redis/quickstarts/fastlycompute) for an up-to-date version.
