...
When you publish a post, delete or update a post, etc. and want to be notified on your own infrastructure, that's what webhooks are for.
...
>
> — **Dominik Koch, Co-Founder MarbleCMS**
...
const eventSchema = z.object({
  // 👇 event name -> expected event data
...
export class WebhookClient {
  ...
  constructor({ secret }: { secret: string }) {
    // 👇 we'll need this later to sign our webhooks
    this.secret = secret;
  }
