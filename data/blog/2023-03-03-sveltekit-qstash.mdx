...
- An [Upstash](https://upstash.com/) account so you can access QStash. The [free plan](/pricing/qstash) allows you to send a small number of messages per day, which should be plenty for our use case.
