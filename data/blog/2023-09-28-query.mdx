...
Searches and filters are blazing fast, check out the source code of the demo [here](https://github.com/upstash/examples/tree/main/examples/upstash-query).
...
const upstashDeployments = await deploymentsByOrganization.match({ organization: "Upstash" });
```
