...
We will use the [@agentic/hacker-news](https://github.com/transitive-bullshit/agentic/blob/main/legacy/docs/tools/hacker-news.mdx) package to fetch the top stories from Hacker News, no API key required.
