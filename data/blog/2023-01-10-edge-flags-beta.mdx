...
Each flag can have a [percentage](https://github.com/upstash/edge-flags/blob/main/docs/percentage.md) defined, allowing you to rollout flags gradually to a random subset of your users.
...
To learn more about differen rule types, please check out the [rules documentation](https://github.com/upstash/edge-flags/blob/main/docs/rules.md).
...
For a full list of features and some explanations, please check out the [documentation](https://github.com/upstash/edge-flags) and stay tuned for a technical deep dive blog post soon<sup>TM</sup>.
...
- [Documentation](https://github.com/upstash/edge-flags/blob/main/docs/overview.md)
