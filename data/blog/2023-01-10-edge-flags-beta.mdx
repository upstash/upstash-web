...
Feature flags are a great way to dynamically change the behavior of your app without redeploying. We're excited to announce the public
...
Each flag can have a [percentage](/docs/redis/sdks/edge-flags/percentage) defined, allowing you to roll out flags gradually to a random subset of your users.
...
To learn more about different rule types, please check out the [rules documentation](/docs/redis/sdks/edge-flags/rules).
...
#### 2. Install `@upstash/edge-flags` with your favorite package manager:
...
To reduce the requests made to Redis and thus decrease your bill at the end of the month, we will be adding different ways to cache flags.
...
There are pros and cons to each, and we would appreciate it if you share your feedback and ideas.
