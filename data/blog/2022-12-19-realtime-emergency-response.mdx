...
In the current global context, natural disasters and military treats are becoming more and more prevalent. So does the need for digitalisation in the social services area.
...
To better understand our application's flow, let's look at this diagram(created with [diagrams.net](https://www.diagrams.net/)): 
