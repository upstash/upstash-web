...
- If a user visits some page on the website and the response to this
...
users are to switch to GitHub way of creating profile.
...
Deploying requires an account on Edgio.
