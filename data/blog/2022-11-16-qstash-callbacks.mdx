...
Using callbacks opens up a lot of new use cases. For example, you can now use QStash to call third-party APIs and use the response to update your database.
