...
To implement caching, we'll use the [`strapi-plugin-rest-cache` package](https://community.strapi.io/marketplace/strapi-community-plugin-rest-cache), which is already available on Strapi marketplace.
