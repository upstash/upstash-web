...
I am excited to announce the JSON support in Upstash for Redis®. This means Upstash is compatible [RedisJSON API](https://redis.io/docs/latest/develop/data-types/json/). You can leverage RedisJSON API using these [client libraries](https://redis.io/docs/latest/develop/data-types/json/) as well as [Upstash SDK for Redis](/docs/redis/sdks/javascriptsdk/modules/json).
