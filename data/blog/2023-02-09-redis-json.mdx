...
### What is RedisJSON?
<Note info>
Upstash does not use or copy [RedisJSON](https://redis.io/docs/stack/json/) which is licensed by Redis® Ltd. Upstash provides a custom implementation of RedisJSON compatibility.
</Note>
