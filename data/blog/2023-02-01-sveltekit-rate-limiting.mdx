...
There is an [open SvelteKit feature request](https://github.com/sveltejs/kit/issues/8764) for rate limiting to be provided by SvelteKit itself, though there isn't a clear solution since SvelteKit doesn't come with a database.
