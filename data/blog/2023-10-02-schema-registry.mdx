...
Get the required parameters from related Kafka instace page at [Upstash Console](https://console.upstash.com).
...
You can use it with the `KafkaAvroSerializer/Deserializer` in Producer/Consumer.
...
You can also use it programatically via java client [SchemaRegistryClient](https://github.com/confluentinc/schema-registry/blob/master/client/src/main/java/io/confluent/kafka/schemaregistry/client/SchemaRegistryClient.java) and
