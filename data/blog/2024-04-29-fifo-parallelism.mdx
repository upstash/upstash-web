...
Another highly requested feature was batch processing, aimed at boosting performance. Now, you can send batches of messages effortlessly. You can even combine  [topics (which has been renamed as URL Groups)](/docs/qstash/features/url-groups) and [queues](/docs/qstash/features/queues) with batching:
