...
Sign up for an Upstash account by visiting [the login page](https://console.upstash.com/auth/sign-in), selecting the "Sign Up" option, and following the prompts.
