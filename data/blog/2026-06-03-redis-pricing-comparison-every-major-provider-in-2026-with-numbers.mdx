...
<Summary>
The hardest part of comparing Redis pricing is that most of the big providers charge for one of four very different things. We can't really compare a price like "$0.049 per GiB-hour" to "$0.20 per 100,000 commands" until we know how our app uses Redis.

**So later in this article I calculated the price of five example workloads on every provider, instead of just listing rates.**
</Summary>
