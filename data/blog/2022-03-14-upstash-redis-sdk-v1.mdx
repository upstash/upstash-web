...
If you are unsure how a command can be used, typescript will help you if your editor supports intellisense. Also check out the [test](https://github.com/upstash/redis-js/tree/main/packages/redis/pkg/commands) that covers everything and can serve as examples.
