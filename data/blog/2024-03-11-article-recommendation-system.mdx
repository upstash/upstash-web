...
> Note: By appending `.server.ts` to a file in Remix, you're able to make sure that it's code is [forced **out** of the client side bundle](https://github.com/remix-run/remix/blob/ac747ff7cdd8dde2b50fdf392fce0a29bbf2257f/decisions/0009-do-not-rely-on-treeshaking-for-correctness.md#server-modules).
