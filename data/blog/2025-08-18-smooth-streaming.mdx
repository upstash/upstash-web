...
To be totally transparent, you can use this component for _any text_ you want to animate 🗿. There is no limitation or special sauce that makes it specific to the AI SDK: any text you might have (even a hard-coded string) can be animated with this component.
...
I got this idea from building a side project. You can see a full demo video of the chat experience [on the homepage](https://contentport.io).
