...
Relevant documentation:
  ...
  * [QStash Rest API](https://upstash.com/docs/qstash/api-reference/flow-control/get-flow-control-key)
  * [Workflow Rest API](/docs/workflow/api-reference/flow-control/get-flow-control-key)
...
Documentation: 
- [Pin And Unping Config](https://upstash.com/docs/qstash/features/flowcontrol#pin-and-unpin) to change the config dynamically.
- [Pause And Resume](https://upstash.com/docs/qstash/features/flowcontrol#pause-and-resume)
...
It also makes it much easier for us to add new features in the future. We have already pans for [Debounce](https://github.com/orgs/upstash/discussions/158) and [Priority](https://github.com/orgs/upstash/discussions/183)
If you have ideas or feature requests related to flow control, please reach out via [Discord](https://discord.gg/jUxUYE4nEB)
