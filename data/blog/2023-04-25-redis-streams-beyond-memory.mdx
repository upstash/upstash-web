...
with existing systems(databases, data lakes, logging platforms etc), thanks to [Connectors](https://upstash.com/blog/kafka-connectors), you can
...
For more details, see this [tutorial](https://redis.io/docs/latest/develop/data-types/streams/).
