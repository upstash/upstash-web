...
**1. Open the export page.** In the [Context7 Cloud dashboard](https://context7.com), open **More → Export Libraries**. This page is available to Context7 on-premise customers.
