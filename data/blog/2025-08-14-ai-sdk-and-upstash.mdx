...
Personally, I am not an AI expert, I only use such models to realize the ideas that comes to my mind time to time. So I don't want to waste time on the hustle of configurations, settings, etc.
...
Speaking of abstractions and developer experience, Upstash products are also quite handy, and focused on hiding the complexity from the developers, providing cool SDKs.
