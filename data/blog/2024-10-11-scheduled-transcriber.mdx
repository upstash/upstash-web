...
| [Cloudflare R2](https://www.cloudflare.com) | A cloud object storage service. |
...
- [Fireworks Transcribe Audio API](https://docs.fireworks.ai/examples/cookbooks#multimodal-ai)
