...
Server Actions are basically publicly accessible HTTP endpoints that only use the `POST` method. Even if they are not imported elsewhere in your code they are public, you should treat them as such and secure them.
