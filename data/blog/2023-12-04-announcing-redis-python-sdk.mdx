...
Today we are releasing `v1.0.0` version of the `upstash-redis` python package.

It is a connectionless HTTP-based client for upstash redis,
...
The sdk now has python docstrings for every command with example usages in them.

The documentation and examples for every command can also be found at [https://upstash.com/docs/oss/sdks/py/redis/commands/overview](https://upstash.com/docs/oss/sdks/py/redis/commands/overview)
...
### Geo commands returning `GeoSearchResult`
