...
We will use [Vercel Edge Middleware](https://vercel.com/docs/concepts/functions/edge-middleware) and [Upstash Edge Flags](https://github.com/upstash/edge-flags/blob/main/docs/overview.md).
...
[Edge flags documentation](https://github.com/upstash/edge-flags)
