...
We will use [Vercel Edge Middleware](https://vercel.com/docs/concepts/functions/edge-middleware) and [Upstash Edge Flags](https://docs.upstash.com/redis/sdks/edge-flags/overview).
...
### Links
[Edge flags documentation](https://docs.upstash.com/redis/sdks/edge-flags/getstarted)
