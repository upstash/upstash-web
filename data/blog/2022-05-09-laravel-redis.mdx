...
- If you don't have Laravel installed, you can follow the steps on how to do that here: [Install Laravel with 1-click](https://devdojo.com/post/bobbyiliev/how-to-install-laravel-on-digitalocean-with-1-click)
