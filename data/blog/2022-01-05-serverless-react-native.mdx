...
In our case, the first step is creating an Upstash account [Console](https://console.upstash.com/auth/sign-in). Secondly, create an Upstash database as you wish. Then, it is ready to go!
...
Let’s start by installing and configuring Serverless Framework for AWS. Visit and follow the steps [Serverless quick start](https://www.serverless.com/framework/docs/getting-started).
