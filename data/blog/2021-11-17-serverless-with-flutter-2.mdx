...
The `timeago` library is for converting Unix timestamps (1636824843) into human-readable formats like `a minute ago`, `5 mins ago`, etc.
...
One of our endpoints allowed a user to create a post. Here's how the screen looks
