...
* [Upstash signup](https://console.upstash.com/auth/sign-in)
* Quix signup
...
To get started, create a Quix template.
...
* It uses the concept of streaming dataframes which makes it a lot easier to process data, and reuse Pandas code written for static datasets.
...
* To learn more about the Quix Streams Python library, check out the [introduction](https://quix.io/docs/quix-streams/introduction.html) in the Quix documentation.
* To see more Quix project template, check out the [Quix template gallery](https://github.com/quixio/quix-samples).
