...
Open your website in the built-in browser in the ChatGPT desktop app. Ask ChatGPT Work or Codex a question such as:

> Use the available site tools to find out how I can connect to Upstash Redis from Next.js.

Select **Site tools** in the browser's address bar, then select **Available site tools**. You should see `search_upstash_docs`. After a call, you can review it under **Recently used**.

Site tool availability depends on your account, app version and rollout. If the menu is missing, update the ChatGPT desktop app and check the [current availability notes](https://learn.chatgpt.com/docs/webmcp).
