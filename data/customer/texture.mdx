...
company_url: texture.energy
company_logo: logo-texture-b.svg
company_logo_dark: logo-texture.svg
...
<Highlight name="Victor Quinn" title="Cofounder and CTO" photo="victor.jpeg">
  We switched from Confluent to Upstash as the pricing model is much more
  reasonable. Not only on cost, technically Upstash also works better with
