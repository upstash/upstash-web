      ...
      <Box as="section" py={["70px", "100px"]}>
        <Container maxW="5xl">
          <SimpleGrid columns={[1, 2]} spacing={10} alignItems="center">
            ...
            <div>
              <img
                src="/assets/upstash-edge.svg"
                alt="Serverless Database for Edge"
              />
            </div>
          </SimpleGrid>
        </Container>
      ...
      <Section py={["100px", "140px"]}>
        ...
        <Container maxW="5xl">
          <SimpleGrid mt={[10, 20]} columns={[1, 3]} spacing={6}>
            ...
            {/**/}
            <SupportCard href={"https://blog.upstash.com/roadmap-application"}>
              <SectionSupportIconNext />
              <Text>
            ...
            {/**/}
            <SupportCard href={"https://blog.upstash.com/nextjs-todo"}>
              <SectionSupportIconNext />
              <Text>
                <b> TODO App</b>
                <br />
