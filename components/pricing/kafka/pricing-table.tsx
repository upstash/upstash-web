...
export default function PricingTable() {
  return (
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="rounded-3xl px-4 py-8 flex flex-col gap-6 items-center bg-emerald-300/10 border-2 border-emerald-300/10">
        <div className="grow">
        ...
        <div>
          <p className="text-sm text-emerald-100/40">Max Messages Daily</p>
          <p className="font-semibold">Unlimited</p>
        </div>

        <div>
          <p className="text-sm text-emerald-100/40">Max Message Per Second</p>
          <p className="font-semibold">1,000</p>
        </div>
