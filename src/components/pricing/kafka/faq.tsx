      ...
      <AccordionItem value="item-7">
        ...
        <AccordionContent>
          <p>
            ...
            200GB. Beyond that, we charge $0.1 for each additional GB data
            transfer.
          </p>
          <p>
            For Pro and Enterprise plans, it is charged at a rate of $0.1 per GB
            out and $0.05 per GB in for all the usage throughout the month. For
            use cases with high volume, you may consider VPC Peering which
            minimizes the data transfer cost. Contact us at{" "}
