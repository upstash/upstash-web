    ...
    >
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          <ul className="mt-4 list-disc space-y-2 pl-6">
            <li>
              A <b>step</b> is the execution of a single workflow step in your
              workflow.
            </li>
            <li>
            ...
            <li>
              ...
              <ul className="mt-2 list-disc space-y-2 pl-6">
                <li>
                  ...
                  <code>context.waitForEvent</code> generate{" "}
                  <b>ONE billed step</b>.
                </li>
                <li>
                  <code>context.call</code> and <code>context.invoke</code>{" "}
                  generate <b>TWO billed steps</b>.
                </li>
                <li>
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li>
              Short or occasional spikes will not immediately block step
              executions.
            </li>
            <li>
            ...
            <li>
              ...
              time, workflow runs may start failing with quota errors.
            </li>
          </ul>
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        ...
        <AccordionContent>
          ...
          <ul className="mt-4 list-disc space-y-2 pl-6">
            <li>QStash starts returning errors for step execution.</li>
            <li>
              The Workflow SDK throttles execution and retries after a short
              delay.
            </li>
            <li>If the retry limit is reached, the workflow run fails.</li>
            <li>
        ...
        <AccordionContent>
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li className="space-y-2">
              ...
              <ul className="mt-2 list-disc space-y-2 pl-6">
                <li>Workflow accepts all step executions.</li>
                <li>
                  If usage is too high, execution is slowed down by limiting how
                  many steps run in parallel.
                </li>
                <li>Additional steps are queued and executed later.</li>
              </ul>
              <p className="mt-2">
        ...
        <AccordionContent>
          <ul className="mt-4 list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              <code>context.invoke</code> are also subject to the max message
              size limit.
            </li>
            <li>
