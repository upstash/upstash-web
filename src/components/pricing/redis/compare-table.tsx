    ...
    return (
        <table className="w-full border-separate border-spacing-x-1 border-spacing-y-0">
            ...
            <tr>
                ...
                >
                    <div
                        className="-ml-4 flex h-24 items-center bg-gradient-to-r from-zinc-900 to-zinc-950 px-4 md:h-16">
            ...
            <tr>
                <th className="px-0 text-left font-normal text-white/60">
                    <Tooltip
                        content="This is the maximum size per your entry. The entry can be String, List, Set, Hash etc.">
              <span className="underline decoration-zinc-500 decoration-dashed">
                Max record size
              </span>
                    </Tooltip>
