...
export const SkillsBanner = () => {
  return (
    <a
      ...
      className="group flex h-9 w-full items-center justify-center gap-1.5 border-b border-emerald-500/20 bg-emerald-100 px-4 text-[13px] leading-none text-emerald-950 transition-colors hover:bg-emerald-200 md:text-sm dark:bg-emerald-950 dark:text-emerald-100 dark:hover:bg-emerald-900"
    >
