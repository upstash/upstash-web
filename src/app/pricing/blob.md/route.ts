...
function generateMarkdown(): string {
  const lines: string[] = [
    ...
    "- **Bandwidth** — bytes moved in *or* out of the bucket. An upload is billed",
    "  at the same rate as a download.",
    "",
    "Requests that fail on the caller's side (404, 412, 416, 429) are counted as",
    "operations and billed at the same rate as successful ones.",
    "",
    "---",
    "",
    "## Plan Overview",
