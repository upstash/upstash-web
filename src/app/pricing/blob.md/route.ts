...
function generateMarkdown(): string {
  const lines: string[] = [
    ...
    "- **Bandwidth**: bytes that *leave* the bucket. Free up to 1 TB a month on",
    "  pay-as-you-go. Uploads are always free: writing an object costs storage",
    "  and one advanced operation, but no bandwidth.",
    "",
    ...
    "column is the rate, billed from the first byte and the first operation,",
    "except egress, which is free up to 1 TB a month.",
    "",
    "---",
    "",
    "## Plans",
