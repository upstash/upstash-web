...
const description =
  "Upstash is a serverless data platform for Redis, Vector, and QStash, providing low latency and high scalability for real-time applications. Optimize your data infrastructure with Upstash's managed services for Redis, Vector, QStash, and other key data technologies.";
